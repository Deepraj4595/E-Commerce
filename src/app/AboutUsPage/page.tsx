...
const AboutUsPage = () => {
    ...
    return (
        <div>
            <Header />
            {/* About Section */}
            <section ref={aboutRef} className="relative pt-16 pb-24 bg-gradient-to-b from-white to-[#87CEEB] overflow-hidden">
                    ...
                    <div className="md:flex items-center justify-end">
                        ...
                        <div className="lg:w-[55%] space-y-6">
                            ...
                            <p className="text-lg text-gray-700 leading-relaxed">
                                Established in 2019, GurOm Dental has rapidly grown into a comprehensive dental
                                solutions provider, catering to clinics, labs, and dental professionals across India. Our goal
                                is to bring innovation and excellence to every aspect of dental care – from clinic
                                services to materials and equipment.
                            </p>
                            {/* CTA BUTTONS */}
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        >
                            ...
                            <p className="text-lg text-gray-700 mt-4">
                                To revolutionize the dental industry by providing world-class, innovative dental care and
                                solutions that improve patient outcomes and the quality of dental practices.
                            </p>
                        </motion.div>
                        ...
                        >
                            ...
                            <p className="text-lg text-gray-700 mt-4">
                                We are committed to delivering exceptional dental services, superior materials, and cutting-edge
                                equipment to ensure that every patient receives the best care, and every clinic
            ...
            <section className="py-20 bg-gradient-to-b from-white to-gray-100">
                <div className="container mx-auto px-6 lg:px-16 text-center">
                    <h2 className="text-5xl font-bold text-gray-900">Meet Our Team</h2>
                    <p className="text-lg text-gray-700 mt-4 max-w-2xl mx-auto">
                        Our team includes experienced dental professionals, skilled lab technicians, and cutting
                        edge engineers dedicated to developing the best dental solutions available. From our
                        clinicians to our material experts, we ensure every aspect of our service reflects our
                        commitment to quality.
                    </p>
                    <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-12">
                        {["Clinicians", "Lab Technicians", "Material Experts"].map((role, index) => (
                            <motion.div
                                key={index}
                                initial={{ opacity: 0, y: 50 }}
                                animate={{ opacity: 1, y: 0 }}
                                transition={{ duration: 1, delay: index * 0.3 }}
                                className="group bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-2xl transition duration-300"
                            >
                                <h3 className="text-2xl font-semibold text-blue-700 group-hover:text-blue-900">{role}</h3>
                                <p className="text-gray-600 mt-4">
                                    Dedicated specialists ensuring excellence in every aspect of our dental solutions.
                                </p>
                            </motion.div>
                        ))}
                    </div>
